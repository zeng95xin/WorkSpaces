...
<script type="text/javascript">
	...
	$(function() {
		...
		$('#form').form({
			url : '${basePath}/web/QuestionnaireClassifyWebController/edit',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="">
		<form id="form" method="post">
				<input type="hidden" value="${questionnaireClassify.id }" name="id">
			<table class="table table-hover table-condensed">
				<tr>
					<th>名称</th>
					<td>
					<input type="text" name="classifyName" vaule="${questionnaireClassify.classifyname }" class="easyui-validatebox span2" 

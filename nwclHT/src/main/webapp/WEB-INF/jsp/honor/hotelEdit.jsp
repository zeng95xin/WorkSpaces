...
<script type="text/javascript">
	...
	$(function() {
		...
		parent.$.messager.progress('close');
		$('#form').form({
			url : '${basePath}/web/honor/editHotel',
			onSubmit : function() {
				editor.sync();
	...
	function setImagePreview() {
		...
		for (var i = 0; i < fileList.length; i++) {
			...
			$("#localImag").prepend("<li style='float:left;margin:10px' > <img id='preview" + i + "'  /> </li>");
	...
	function setPicPreview() {
		...
		var fileList = docObj.files;
		for (var i = 0; i < fileList.length; i++) {
			localImag.innerHTML += "<li style='float:left;margin:10px' > <img id='previews" + i + "'  /> </li>";
	...
	<div data-options="region:'center',border:false" title="">
		<form id="form" method="post" encType="multipart/form-data" >
			...
			<table class="table table-hover table-condensed">
				<tr>
					<th style="text-align: right; width: 70px;">酒店图片</th>
					<td>
						<div>
				...
				<tr>
					<th style="text-align: right; width: 70px;">添加酒店图片</th>
					<td>
				...
				<tr>
					<th style="text-align: right; width: 70px;">酒店名称</th>
				...
				<tr>
					<th style="text-align: right; width: 70px;">酒店地址</th>
					<td><input name="address" type="text" style="width: 300px;"
						placeholder="" class="easyui-validatebox span2"
						data-options="required:true" value="${model.address }"></td>
				</tr>
				<tr>
				...
				<tr>
					<th style="text-align: right; width: 70px;">酒店联系人头像</th>
					<td>
					<div>
						<div>
							...
							<ul class="page_imgs clearfix" id="localPic"
								style="list-style-type: none">
								<li> <img alt="" src="${model.userPicture }" style="height: 97px";width="116px"> </li>
								<li><input type="button" value="上传头像" style="margin-left: 10px;" id="doUpPic"></li>
							</ul>
						</div>
					</div>
					</td>
				...
				<tr>
					<th style="text-align: right; width: 70px;">酒店联系人姓名</th>
					<td><input name="userName" type="text" style="width: 200px;"
						placeholder="" class="easyui-validatebox span2"
						data-options="required:true" value="${model.userName }"></td>
				</tr>
				<tr>
					<th style="text-align: right; width: 70px;">酒店联系人职位</th>
					<td><input name="userPosition" type="text"
						style="width: 200px;" placeholder="" value="${model.userPosition }"
						class="easyui-validatebox span2" data-options="required:true">
					</td>
				</tr>
				<tr>
					<th style="text-align: right; width: 70px;">酒店联系人电话</th>
					<td><input name="userPhone" type="text" style="width: 200px;"
						placeholder="" class="easyui-validatebox span2"
						data-options="required:true" value="${model.userPhone }"></td>
				</tr>

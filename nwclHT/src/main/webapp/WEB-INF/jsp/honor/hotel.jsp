...
$(function() {
	dataGrid = $('#dataGrid').datagrid({
		url : '${basePath}/web/honor/dataGrid?type=1',
		fit : true,
		fitColumns : true,
		border : false,
		pagination : true,
...
function  addFun(){
	parent.$.modalDialog({
		...
		width : 800,
		height : 600,
		href : '${basePath}/web/honor/hotelAddPage',
		buttons : [{
				text : '添加',
				handler : function(){
...
function editFun(id) {
	...
	parent.$.modalDialog({
		...
		width : 800,
		height : 600,
		href : '${basePath}/web/honor/hotelEditPage?id=' + id,
		buttons : [ {
			text : '保存',
			handler : function() {
				parent.$.modalDialog.openner_dataGrid = dataGrid;//因为添加成功之后，需要刷新这个dataGrid，所以先预定义好
...
<body>
	...
	<div id="toolbar" style="display: none;">
		...
		<a onclick="productFun();" href="javascript:void(0);" class="easyui-linkbutton" data-options="plain:true,iconCls:'door_in'">酒店床位</a>
	</div>

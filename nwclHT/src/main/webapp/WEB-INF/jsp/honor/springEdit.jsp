...
<script type="text/javascript">
	$(function() {
		...
		parent.$.messager.progress('close');
		$('#form').form({
			url : '${basePath}/web/honor/editSpring',
			onSubmit : function() {
				editor.sync();
	...
	<div data-options="region:'center',border:false" title="">
		<form id="form" method="post" encType="multipart/form-data" >
			...
			<table class="table table-hover table-condensed">
				<tr>
					<th style="text-align: right; width: 70px;">图片</th>
					<td>
						<div>
				...
				<tr>
					<th style="text-align: right; width: 70px;">添加图片</th>
					<td>
				...
				<tr>
					<th style="text-align: right; width: 70px;">简介</th>
				...
				<tr>
					<th style="text-align: right; width: 70px;">介绍</th>
				...
				<tr>
					<th style="text-align: right; width: 70px;">联系人头像</th>
					<td>
						<div>
						<div>
				...
				<tr>
					<th style="text-align: right; width: 70px;">联系人电话</th>

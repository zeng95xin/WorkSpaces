...
function setImagePreview() {
	...
	$(function() {
		...
		$('#form').form({
			url : '${basePath}/web/BizUserWebController/addBUser',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="">
		...
		<input type="hidden" value="${bizUser.id }" name="bizUserId">
		<input type="hidden" value="${bizUser.currentRoomId }" name="currentRoomId">
			<table class="table table-hover table-condensed">
					
				<tr>
					<th>头像</th>
					<td colspan="3">
						<div id="localImag"><img id="preview"  src="" style="diplay:none" /></div>
				...
				<tr>
					<th>业主</th>
					<td>
					<input name="bizUserName" type="text" class="easyui-validatebox span2"  
					data-options="required:true" value="${bizUser.nickname }" readonly="readonly">
					</td>
					<th>与业主关系</th>
					<td>
					<select name="relation" class="easyui-validatebox span2"  data-options="required:true" >

			...
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<td><select name="typeId" class="easyui-combobox" data-options="width:140,height:29,editable:false,panelHeight:'auto'">
							<option value="0" <c:if test="${0 == resource.typeId}">selected="selected"</c:if>>菜单</option>
							<option value="1" <c:if test="${1 == resource.typeId}">selected="selected"</c:if>>功能</option>
					</select></td>
				</tr>
				<tr>
					<th>上级资源</th>
					<td><select id="pid" name="pid" style="width: 140px; height: 29px;"></select><img src="${basePath}/style/images/extjs_icons/cut_red.png" onclick="$('#pid').combotree('clear');" /></td>
				</tr>
				<tr>
					<th>菜单图标</th>

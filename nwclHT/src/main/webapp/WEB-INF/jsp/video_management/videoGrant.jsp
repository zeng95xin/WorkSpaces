	...
	$(function() {
		resourceTree = $('#resourceTree').tree({
			...
			onLoadSuccess : function(node, data) {
				...
				$('#roleGrantLayout').layout('panel', 'west').panel('setTitle', $.formatString('[{0}]给角色授权', '${role.name}'));
		...
		$('#form').form({
			url : '${basePath}/web/VideoManagement/grant',
			onSubmit : function() {
...
<div id="roleGrantLayout" class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'west'" title="视频资源" style="width: 300px; padding: 1px;">

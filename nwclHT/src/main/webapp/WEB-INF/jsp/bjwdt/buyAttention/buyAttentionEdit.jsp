...
function setImagePreview() {
	...
	$(function() {
		...
		$('#form [name="detail"]').val(parent.$.modalDialog.rowData.detail);
		$('#form input[name="loretype"]').val(parent.$.modalDialog.rowData.loretype);
		...
		$('#form').form({
			url : '${ctx}/web/bjwdt/buyAttention/edit',
			...
			<table class="table table-hover table-condensed">
				<tr>
					...
					<td>
						...
						<input type="hidden" name="oldImgPath">
					</td>				
				</tr>
				<tr>
					<th style="text-align: right;">名称</th>
					<td>
						<input name="name" type="text" class="easyui-validatebox" placeholder="版本号" data-options="required:true" style="width: 300px">
					</td>
				</tr>
				<tr>
					<th>图片</th>

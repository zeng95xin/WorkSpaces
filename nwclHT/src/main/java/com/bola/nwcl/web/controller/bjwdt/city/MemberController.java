 ...
 */
@Controller
@RequestMapping(value = "web/bjwdt/member")
public class MemberController extends BaseController{
	...
	public BaseResult add(HttpServletRequest request,
		...
		if (file != null && !file.isEmpty()) {
			...
			memberimg = FileUploadDeleteUtil.upload(file, request, uploadPath, fileName);
		}
	...
	public String addPage(HttpServletRequest request) {
		return "/bjwdt/member/memberAdd";
	}

	@RequestMapping("/editPage")
	public String editPage(HttpServletRequest request, Long id) {
		return "/bjwdt/member/memberEdit";
	}

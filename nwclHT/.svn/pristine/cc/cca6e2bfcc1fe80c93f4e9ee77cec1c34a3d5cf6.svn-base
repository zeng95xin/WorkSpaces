		...
		<form id="form" method="post" encType="multipart/form-data">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<td><input name="no" type="text" style="width: 200px;"
						placeholder="标题" class="easyui-validatebox span2"
						data-options="required:true" value="${model.deptNo }"></td>
				</tr>
				<tr>
					<th style="text-align: right; width: 50px;">部门名称</th>
					<td><input name="name" type="text" style="width: 200px;"
						placeholder="标题" class="easyui-validatebox span2"
						data-options="required:true" value="${model.deptName }"></td>
				</tr>
				<tr>

...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${ctx}/web/maintenancePrice/add',
			onSubmit : function() {
...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title="">
		<form id="form" method="post">
			<input type="hidden" name="serviceTypeId" value="${type }">
			<table class="table table-hover table-condensed">
				...
				<tr>
					...
					<td><input name="unit" type="text" style="width: 210px;"
						placeholder="个，支，米" class="easyui-validatebox span2"></td>
				</tr>			
				<tr>
					<th style="text-align: right; width: 100px;">普通楼盘标准</th>
					<td><input name="normalServicePrice" type="text" style="width: 210px;"
						placeholder="元" class="easyui-validatebox span2"></td>
				</tr>
				<tr>

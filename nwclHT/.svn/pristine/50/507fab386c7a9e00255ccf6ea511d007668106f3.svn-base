 ...
 */
@Controller
@RequestMapping(value = "web/bjwdt/payment")
public class PaymentController extends BaseController{
	...
	public String manager(HttpServletRequest request, String ownerCode) {
		request.setAttribute("ownerCode", ownerCode);
		return "/bjwdt/payment/payment";
	}

	@RequestMapping("/dataGrid")
	@ResponseBody
	public DataGrid dataGrid(PageHelper ph,HttpServletRequest request, String ownerCode) {
	...
	public String addPage(HttpServletRequest request) {
		return "/bjwdt/payment/paymentAdd";
	}

	@RequestMapping("/editPage")
	public String editPage(HttpServletRequest request, Long id) {
		return "/bjwdt/payment/paymentEdit";
	}

	@RequestMapping("/add")
	@ResponseBody
	public BaseResult add(HttpServletRequest request, String appType, String verision, String desc, String url, String flagObliged) {
	...
	@RequestMapping("/edit")
	@ResponseBody
	public BaseResult edit(HttpServletRequest request, String code, String verision, String desc, String url, String flagObliged) {

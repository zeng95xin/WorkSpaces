...
<script type="text/javascript">
	$(function() {
		...
		$('#form').form({
			url : '${basePath}/web/VideoManagement/edit',
			onSubmit : function() {
		...
		<form id="form" method="post" encType="multipart/form-data">
			...
			<tr><td><input name="id" type="hidden" value="${model.id}" ></td></tr>
				<tr>
					...
					<td>
					<input type="text" name="url" id="url" class="file" value="${model.url}" style="width: 200px;" class="easyui-validatebox span2" data-options="required:true" placeholder="请输入视频地址"><br/>
					</td>
				</tr>
				<tr>
					<th style="text-align: right; width: 60px;">视频名称:</th>
					<td>
						<input type="text" id="name" name="name" value="${model.name}" style="width: 200px;" class="easyui-validatebox span2" data-options="required:true" placeholder="请输入视频名称(最大20个字)"/>
					</td>
				</tr>
				<tr>
					<th style="text-align: right; width: 60px;">设备码:</th>
					<td>
						<input type="text" readonly="readonly" value="${appKey}" style="width: 200px;" class="easyui-validatebox span2"  name="appKey" id="appKey" />
					</td>
				</tr>
				<tr>
					<th style="text-align: right; width: 60px;">应用秘钥:</th>
					<td>
						<input type="text" readonly="readonly" value="${secret}" style="width: 200px;" class="easyui-validatebox span2"  name="secret" id="secret" />
					</td>
				</tr>
			</table>
		</form>

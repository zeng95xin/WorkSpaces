	...
	<div data-options="region:'center',border:false" title="">
		<form id="form" method="post" encType="multipart/form-data">
			<table class="table table-hover table-condensed">
				...
				<tr>
					<th style="text-align: right; width: 50px;">角色名称</th>
					<td><input name="name" type="text" style="width: 200px;"
						placeholder="角色名称" class="easyui-validatebox span2"
						data-options="required:true" value="${model.roleName }"></td>
				</tr>
				<tr>
					<th style="text-align: right; width: 50px;">备注</th>
					<td><textarea name="note" style="width: 210px;"
							class="easyui-validatebox span2">${model.roleNote }</textarea></td>
				</tr>				
			</table>
		</form>
	</div>

...
function setImagePreview() {
	...
	$(function() {
		...
		$('#form').form({
			url : '${basePath}/web/bjwdt/member/add',
			onSubmit : function() {
...
<tr><th style="text-align: right;">是否在售</th><td><input type="text" class="easyui-validatebox" style="width: 300px" name="flagsale"></td></tr>
<tr><th style="text-align: right;">价格</th><td><input type="text" class="easyui-validatebox" style="width: 300px" name="bannerprice"></td></tr>
...
<tr><th style="text-align: right;">楼层状况</th><td><input type="text" class="easyui-validatebox" style="width: 300px" name="descbanner"></td></tr>
...
<tr><th style="text-align: right;">地址</th><td><input type="text" class="easyui-validatebox" style="width: 300px" name="banneraddress"></td></tr>
